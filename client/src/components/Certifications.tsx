        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-col items-center">
              <img src={iso} alt="ISO 27001 Certification" className="h-24 w-24 mb-2" />
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-col items-center">
              <img src={soc2} alt="SOC 2 Certification" className="h-24 w-24 mb-2" />
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-col items-center">
              <img src={gdpr} alt="GDPR Compliance" className="h-24 w-24 mb-2" />
          ...
          <Card className="hover:shadow-lg transition-shadow">
            <CardHeader className="flex flex-col items-center">
              <img src={csa} alt="CSA STAR Certification" className="h-24 w-24 mb-2" />
